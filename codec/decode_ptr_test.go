...
func TestDecodePtr_DecodeCommonHash(t *testing.T) {
	in := []byte{0x80, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
func TestDecodePtr_Decode32ByteArray(t *testing.T) {
	in := []byte{0x80, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
	var decodedArray [32]byte
	expectedArray := [32]byte{0xff}
	err := DecodePtr(in, &decodedArray)
	require.Nil(t, err)
	require.Equal(t, expectedArray, decodedArray)
}
