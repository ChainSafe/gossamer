...
// SetFinalizedHash provides a mock function with given fields: hash, round, setID
func (_m *BlockState) SetFinalizedHash(hash common.Hash, round uint64, setID uint64) error {
