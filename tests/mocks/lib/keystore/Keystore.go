...
func (_m *Keystore) GetKeypair(pub crypto.PublicKey) crypto.Keypair {
	ret := _m.Called(pub)
...
func (_m *Keystore) GetKeypairFromAddress(pub common.Address) crypto.Keypair {
	ret := _m.Called(pub)
...
func (_m *Keystore) Insert(kp crypto.Keypair) {
	_m.Called(kp)
}

// Keypairs provides a mock function with given fields:
func (_m *Keystore) Keypairs() []crypto.Keypair {
	ret := _m.Called()
...
func (_m *Keystore) Name() keystore.Name {
	ret := _m.Called()

	var r0 keystore.Name
	if rf, ok := ret.Get(0).(func() keystore.Name); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(keystore.Name)
	}
...
func (_m *Keystore) PublicKeys() []crypto.PublicKey {
	ret := _m.Called()
