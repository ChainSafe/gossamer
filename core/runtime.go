...
func (s *Service) validateTransaction(e types.Extrinsic) (*tx.Validity, error) {
	...
	ret, err := runtime.GetWASMConfiguration(s.rt, runtime.TaggedTransactionQueueValidateTransaction, loc, e)
	if err != nil {
		return nil, err
	}
...
func (s *Service) validateBlock(b []byte) error {
	...
	_, err := runtime.GetWASMConfiguration(s.rt, runtime.CoreExecuteBlock, loc, b)
	if err != nil {
		return err
	}
