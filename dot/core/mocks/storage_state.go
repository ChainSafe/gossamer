...
// ExposeDB provides a mock function with given fields:
func (_m *MockStorageState) ExposeDB() chaindb.Database {
	ret := _m.Called()

	var r0 chaindb.Database
	if rf, ok := ret.Get(0).(func() chaindb.Database); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(chaindb.Database)
		}
	}
