...
func (s *StorageState) StoreTrie(root common.Hash, ts *runtime.TrieState) error {
	var err error
...
func (s *StorageState) TrieState(hash *common.Hash) (*runtime.TrieState, error) {
	if hash == nil {
	...
	return runtime.NewTrieState(s.baseDB, s.tries[*hash])
}
