...
func rpcValidator(cfg *HTTPServerConfig, validate *validator.Validate) func(r *rpc.RequestInfo, //nolint
	i interface{}) error {
	return func(r *rpc.RequestInfo, v interface{}) error { //nolint
		var (
			err       error
			rpcmethod string
		)
