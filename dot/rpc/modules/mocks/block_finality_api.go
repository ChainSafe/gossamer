...
func (_m *MockBlockFinalityAPI) PreCommits() map[ed25519.PublicKeyBytes]*grandpa.Vote {
	ret := _m.Called()
...
func (_m *MockBlockFinalityAPI) PreVotes() map[ed25519.PublicKeyBytes]*grandpa.Vote {
	ret := _m.Called()
