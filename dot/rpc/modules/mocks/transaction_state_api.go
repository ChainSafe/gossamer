...
// MockTransactionStateAPI is an autogenerated mock type for the TransactionStateAPI type
type MockTransactionStateAPI struct {
	mock.Mock
}

// AddToPool provides a mock function with given fields: _a0
func (_m *MockTransactionStateAPI) AddToPool(_a0 *transaction.ValidTransaction) common.Hash {
	ret := _m.Called(_a0)
...
func (_m *MockTransactionStateAPI) Peek() *transaction.ValidTransaction {
	ret := _m.Called()
...
func (_m *MockTransactionStateAPI) Pending() []*transaction.ValidTransaction {
	ret := _m.Called()
...
func (_m *MockTransactionStateAPI) Pop() *transaction.ValidTransaction {
	ret := _m.Called()
