...
func NewMockStorageAPI() *modulesmocks.StorageAPI {
	...
	m.On("GetStorageFromChild", mock.AnythingOfType("*common.Hash"), mock.AnythingOfType("[]uint8"), mock.AnythingOfType("[]uint8")).Return(nil, nil) //nolint:lll
...
func NewMockBlockAPI() *modulesmocks.BlockAPI {
	...
	m.On("SubChain", mock.AnythingOfType("common.Hash"), mock.AnythingOfType("common.Hash")).Return(make([]common.Hash, 0), nil) //nolint:lll
