...
func setupSystemModule(t *testing.T, trieMetrics triemetrics.Metrics) *SystemModule {
	// setup service
	net := newNetworkService(t)
...
func newCoreService(t *testing.T, srvc *state.Service, trieMetrics triemetrics.Metrics) *core.Service {
	// setup service
