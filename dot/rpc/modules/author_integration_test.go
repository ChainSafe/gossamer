...
func TestAuthorModule_SubmitExtrinsic_bad_proof(t *testing.T) {
	...
	testInvalidKeyringPairAlice := signature.KeyringPair{
		URI: "//Alice",
		PublicKey: []byte{0xd4, 0x35, 0x93, 0xc7, 0x15, 0xfd, 0xd3,
			0x1c, 0x61, 0x14, 0x1a, 0xbd, 0x4, 0xa9, 0x9f, 0xd6, 0x82,
			0x2c, 0x85, 0x58, 0x85, 0x4c, 0xcd, 0xe3, 0x9a, 0x56, 0x84,
			0xe7, 0xa5, 0x6d, 0xa2, 0x7d},
