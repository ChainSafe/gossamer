...
//go:generate mockgen -destination=mocks_test.go -package=$GOPACKAGE . Telemetry,StorageState,TransactionState,BabeVerifier,FinalityGadget,BlockImportHandler,Network,WarpSyncProofProvider
