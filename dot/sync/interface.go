...
//go:generate mockery --name BlockState --structname MockBlockState --case underscore --keeptree
...
//go:generate mockery --name BabeVerifier --structname MockBabeVerifier --case underscore --keeptree
...
//go:generate mockery --name FinalityGadget --structname MockFinalityGadget --case underscore --keeptree
...
//go:generate mockery --name BlockImportHandler --structname MockBlockImportHandler --case underscore --keeptree
