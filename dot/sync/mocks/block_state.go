...
type mockConstructorTestingTNewBlockState interface {
	mock.TestingT
	Cleanup(func())
}

// NewBlockState creates a new instance of BlockState. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewBlockState(t mockConstructorTestingTNewBlockState) *BlockState {
	mock := &BlockState{}
	mock.Mock.Test(t)
