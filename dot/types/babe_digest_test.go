...
func TestBabeSecondaryVRFPreDigest_EncodeAndDecode(t *testing.T) {
	...
	err := bh.Set(BabeSecondaryVRFPreDigest{
		VrfOutput: [sr25519.VRFOutputLength]byte{
			...
			204, 43, 31, 179, 28},
		VrfProof: [sr25519.VRFProofLength]byte{
			120, 23, 235, 159, 115, 122, 207, 206, 123, 232, 75, 243,
			115, 255, 131, 181, 219, 241, 200, 206, 21, 22, 238, 16,
			68, 49, 86, 99, 76, 139, 39, 0, 102, 106, 181, 136, 97,
			141, 187, 1, 234, 183, 241, 28, 27, 229, 133, 8, 32, 246,
			245, 206, 199, 142, 134, 124, 226, 217, 95, 30, 176, 246, 5, 3},
		AuthorityIndex: 17,
		SlotNumber:     420,
	})
	require.NoError(t, err)
