...
// MockbabeServiceBuilder is a mock of babeServiceBuilder interface.
type MockbabeServiceBuilder struct {
	ctrl     *gomock.Controller
	recorder *MockbabeServiceBuilderMockRecorder
}

// MockbabeServiceBuilderMockRecorder is the mock recorder for MockbabeServiceBuilder.
type MockbabeServiceBuilderMockRecorder struct {
	mock *MockbabeServiceBuilder
}

// NewMockbabeServiceBuilder creates a new mock instance.
func NewMockbabeServiceBuilder(ctrl *gomock.Controller) *MockbabeServiceBuilder {
	mock := &MockbabeServiceBuilder{ctrl: ctrl}
	mock.recorder = &MockbabeServiceBuilderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockbabeServiceBuilder) EXPECT() *MockbabeServiceBuilderMockRecorder {
	return m.recorder
}

// NewServiceIFace mocks base method.
func (m *MockbabeServiceBuilder) NewServiceIFace(cfg *babe.ServiceConfig) (*babe.Service, error) {
	m.ctrl.T.Helper()
...
func (mr *MockbabeServiceBuilderMockRecorder) NewServiceIFace(cfg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewServiceIFace", reflect.TypeOf((*MockbabeServiceBuilder)(nil).NewServiceIFace), cfg)
}
...
func (m *MocknodeBuilderIface) createBABEService(cfg *Config, st *state.Service, ks keyStore, cs *core.Service, telemetryMailer telemetryClient) (*babe.Service, error) {
	m.ctrl.T.Helper()
...
func (m *MocknodeBuilderIface) createGRANDPAService(cfg *Config, st *state.Service, ks keyStore, net *network.Service, telemetryMailer telemetryClient) (*grandpa.Service, error) {
	m.ctrl.T.Helper()
...
func (m *MocknodeBuilderIface) createNetworkService(cfg *Config, stateSrvc *state.Service, telemetryMailer telemetryClient) (*network.Service, error) {
	m.ctrl.T.Helper()
...
func (m *MocknodeBuilderIface) newSyncService(cfg *Config, st *state.Service, finalityGadget blockJustificationVerifier, verifier *babe.VerificationManager, cs *core.Service, net *network.Service, telemetryMailer telemetryClient) (*sync.Service, error) {
	m.ctrl.T.Helper()
...
func (mr *MocknodeBuilderIfaceMockRecorder) newSyncService(cfg, st, finalityGadget, verifier, cs, net, telemetryMailer interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "newSyncService", reflect.TypeOf((*MocknodeBuilderIface)(nil).newSyncService), cfg, st, finalityGadget, verifier, cs, net, telemetryMailer)
}
