...
func (m *MockTable) importStatement(arg0 *TableContext, arg1 types.SignedFullStatementWithPVD) (*Summary, error) {
	m.ctrl.T.Helper()
...
func (m *MockImplicitView) activeLeaf(arg0 common.Hash) ([]types.ParaID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "activeLeaf", arg0)
	ret0, _ := ret[0].([]types.ParaID)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
