...
func parachainValidators(t *testing.T, ks keystore.Keystore) []parachaintypes.ValidatorPK {
	t.Helper()

	validatorIds := make([]parachaintypes.ValidatorPK, 0, 6)
	...
	for _, kp := range keyPairs {
		var validatorID parachaintypes.ValidatorPK
