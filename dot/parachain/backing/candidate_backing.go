...
type perSessionCache struct {
	...
	validatorsCache *lrucache.LRUCache[parachaintypes.SessionIndex, []parachaintypes.ValidatorPK]
...
func newPerSessionCache(capacity uint) perSessionCache {
	return perSessionCache{
		validatorsCache:          lrucache.NewLRUCache[parachaintypes.SessionIndex, []parachaintypes.ValidatorPK](capacity),
...
func (cache *perSessionCache) getValidators(
	...
	rt runtime.Instance,
) ([]parachaintypes.ValidatorPK, error) {
