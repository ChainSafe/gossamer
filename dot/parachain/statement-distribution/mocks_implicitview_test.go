...
// Source: github.com/ChainSafe/gossamer/dot/parachain/util (interfaces: ImplicitView)
//
// Generated by this command:
//
//	mockgen -destination=mocks_implicitview_test.go -package=statementdistribution github.com/ChainSafe/gossamer/dot/parachain/util ImplicitView
//
...
func (m *MockImplicitView) ActivateLeaf(leafHash common.Hash, ch chan<- any) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ActivateLeaf", leafHash, ch)
	ret0, _ := ret[0].(error)
	return ret0
}

// ActivateLeaf indicates an expected call of ActivateLeaf.
func (mr *MockImplicitViewMockRecorder) ActivateLeaf(leafHash, ch any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ActivateLeaf", reflect.TypeOf((*MockImplicitView)(nil).ActivateLeaf), leafHash, ch)
}
