...
// Source: github.com/ChainSafe/gossamer/dot/parachain/prospective-parachains (interfaces: BlockState)
//
// Generated by this command:
//
//	mockgen -destination=mocks_blockstate_test.go -package=prospectiveparachains . BlockState
//
