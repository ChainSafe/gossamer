...
//
//	mockgen -destination=mocks_runtime_test.go -package=availabilitydistribution github.com/ChainSafe/gossamer/lib/runtime Instance
//
...
func (m *MockInstance) ParachainHostValidators() ([]parachaintypes.ValidatorPK, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParachainHostValidators")
	ret0, _ := ret[0].([]parachaintypes.ValidatorPK)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
