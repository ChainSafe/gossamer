...
// Source: github.com/ChainSafe/gossamer/dot/parachain/availability-distribution (interfaces: BlockState)
//
// Generated by this command:
//
//	mockgen -destination=mocks_blockstate_test.go -package=availabilitydistribution . BlockState
//
