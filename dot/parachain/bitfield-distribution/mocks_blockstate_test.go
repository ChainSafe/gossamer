...
// Source: github.com/ChainSafe/gossamer/dot/parachain/bitfield-distribution (interfaces: BlockState)
//
// Generated by this command:
//
//	mockgen -destination=mocks_blockstate_test.go -package=bitfielddistribution . BlockState
//
