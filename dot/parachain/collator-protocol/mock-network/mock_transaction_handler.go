...
//
//	mockgen -destination=mock-network/mock_transaction_handler.go -package mock_network github.com/ChainSafe/gossamer/dot/network TransactionHandler
//
...
func (m *MockTransactionHandler) HandleTransactionMessage(arg0 peer.ID, arg1 *network.TransactionMessage) (bool, error) {
	m.ctrl.T.Helper()
