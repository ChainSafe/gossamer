...
// Source: github.com/ChainSafe/gossamer/dot/parachain/bitfield-signing (interfaces: BlockState)
//
// Generated by this command:
//
//	mockgen -destination=mocks_blockstate_test.go -package=bitfield_signing . BlockState
//
