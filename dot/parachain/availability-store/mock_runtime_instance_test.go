...
func (m *MockRuntimeInstance) ParachainHostCheckValidationOutputs(parachainID parachaintypes.ParaID, outputs parachaintypes.CandidateCommitments) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRuntimeInstanceMockRecorder) ParachainHostCheckValidationOutputs(parachainID, outputs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ParachainHostCheckValidationOutputs", reflect.TypeOf((*MockRuntimeInstance)(nil).ParachainHostCheckValidationOutputs), parachainID, outputs)
}
...
func (m *MockRuntimeInstance) ParachainHostPersistedValidationData(parachaidID parachaintypes.ParaID, assumption parachaintypes.OccupiedCoreAssumption) (*parachaintypes.PersistedValidationData, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRuntimeInstanceMockRecorder) ParachainHostPersistedValidationData(parachaidID, assumption any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ParachainHostPersistedValidationData", reflect.TypeOf((*MockRuntimeInstance)(nil).ParachainHostPersistedValidationData), parachaidID, assumption)
}

// ParachainHostSessionExecutorParams mocks base method.
func (m *MockRuntimeInstance) ParachainHostSessionExecutorParams(index parachaintypes.SessionIndex) (*parachaintypes.ExecutorParams, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRuntimeInstanceMockRecorder) ParachainHostSessionExecutorParams(index any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ParachainHostSessionExecutorParams", reflect.TypeOf((*MockRuntimeInstance)(nil).ParachainHostSessionExecutorParams), index)
}
...
func (m *MockRuntimeInstance) ParachainHostValidationCode(parachaidID parachaintypes.ParaID, assumption parachaintypes.OccupiedCoreAssumption) (*parachaintypes.ValidationCode, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRuntimeInstanceMockRecorder) ParachainHostValidationCode(parachaidID, assumption any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ParachainHostValidationCode", reflect.TypeOf((*MockRuntimeInstance)(nil).ParachainHostValidationCode), parachaidID, assumption)
}

// ParachainHostValidationCodeByHash mocks base method.
func (m *MockRuntimeInstance) ParachainHostValidationCodeByHash(validationCodeHash common.Hash) (*parachaintypes.ValidationCode, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRuntimeInstanceMockRecorder) ParachainHostValidationCodeByHash(validationCodeHash any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ParachainHostValidationCodeByHash", reflect.TypeOf((*MockRuntimeInstance)(nil).ParachainHostValidationCodeByHash), validationCodeHash)
}
