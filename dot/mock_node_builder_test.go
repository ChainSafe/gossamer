...
func (m *MocknodeBuilderIface) createParachainHostService(config *config.Config, net *network.Service, genesishHash common.Hash) (*parachain.Service, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "createParachainHostService", config, net, genesishHash)
...
func (mr *MocknodeBuilderIfaceMockRecorder) createParachainHostService(config, net, genesishHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "createParachainHostService", reflect.TypeOf((*MocknodeBuilderIface)(nil).createParachainHostService), config, net, genesishHash)
}
