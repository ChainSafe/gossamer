...
func (m *MocknodeBuilderIface) createBABEService(arg0 *config.Config, st *state.Service, ks KeyStore, cs *core.Service, telemetryMailer Telemetry) (*babe.Service, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "createBABEService", arg0, st, ks, cs, telemetryMailer)
...
func (mr *MocknodeBuilderIfaceMockRecorder) createBABEService(arg0, st, ks, cs, telemetryMailer any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "createBABEService", reflect.TypeOf((*MocknodeBuilderIface)(nil).createBABEService), arg0, st, ks, cs, telemetryMailer)
}
...
func (m *MocknodeBuilderIface) createDigestHandler(arg0 *config.Config, st *state.Service) (*digest.Handler, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "createDigestHandler", arg0, st)
...
func (mr *MocknodeBuilderIfaceMockRecorder) createDigestHandler(arg0, st any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "createDigestHandler", reflect.TypeOf((*MocknodeBuilderIface)(nil).createDigestHandler), arg0, st)
}
...
func (m *MocknodeBuilderIface) newSyncService(arg0 *config.Config, st *state.Service, finalityGadget sync.FinalityGadget, verifier *babe.VerificationManager, cs *core.Service, net *network.Service, telemetryMailer Telemetry) (network.Syncer, error) {
	m.ctrl.T.Helper()
