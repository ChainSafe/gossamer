...
3. [Partition recent disputes](https://github.com/paritytech/polkadot-sdk/blob/71c19e4c7ca2b411722ec7d9c1392e1bd81b5681/polkadot/node/core/provisioner/src/disputes/prioritized_selection/mod.rs#L166)
4. [Vote selection](https://github.com/paritytech/polkadot-sdk/blob/71c19e4c7ca2b411722ec7d9c1392e1bd81b5681/polkadot/node/core/provisioner/src/disputes/prioritized_selection/mod.rs#L179C39-L179C49), selects the votes from `PartitionedDisputes` which should be sent to the runtime, votes which are already known on chain are filtered out, the result should be sorted by `(Session Index, Candidate Hash)` (runtime requirement).