...
//go:generate mockery --srcpkg=github.com/ChainSafe/gossamer/internal/primitives/api --name=ConstructRuntimeApi --case=snake --with-expecter=true
//go:generate mockery --srcpkg=github.com/ChainSafe/gossamer/internal/primitives/api --name=ApiExt --case=snake --with-expecter=true
