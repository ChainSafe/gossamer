...
var (
	...
	DefaultID = string("westend_dev")
	// DefaultConfig Default toml configuration path
	DefaultConfig = string("./chain/westend_dev/config.toml")
	// DefaultBasePath Default node base directory path
	DefaultBasePath = string("~/.gossamer/westend-dev")
	...
	DefaultGenesis = string("./chain/westend_dev/westend-dev-spec-raw.json")
