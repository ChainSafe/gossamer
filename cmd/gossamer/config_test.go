	...
	testcases := []struct {
	...
	}{
		{
			...
			dot.RPCConfig{
				...
				WSEnabled:         testCfg.RPC.WSEnabled,
				WSExternalEnabled: testCfg.RPC.WSExternalEnabled,
			},
		},
		{
		...
		{
			"Test gossamer --ws-enabled",
			[]string{"config", "ws-enabled"},
			[]interface{}{testCfgFile.Name(), true},
			dot.RPCConfig{
				Enabled:           testCfg.RPC.Enabled,
				ExternalEnabled:   testCfg.RPC.ExternalEnabled,
		...
		{
			"Test gossamer --ws-enabled false",
			[]string{"config", "w-enabled"},
			[]interface{}{testCfgFile.Name(), false},
			dot.RPCConfig{
				Enabled:           testCfg.RPC.Enabled,
				ExternalEnabled:   testCfg.RPC.ExternalEnabled,
		...
		{
			"Test gossamer --ws-external-enabled",
			[]string{"config", "ws-external-enabled"},
			[]interface{}{testCfgFile.Name(), true},
			dot.RPCConfig{
				Enabled:           testCfg.RPC.Enabled,
				ExternalEnabled:   testCfg.RPC.ExternalEnabled,
				...
				WSPort:            testCfg.RPC.WSPort,
				WSEnabled:         testCfg.RPC.WSEnabled,
				WSExternalEnabled: true,
			},
		},
		{
			"Test gossamer --ws-external-enabled false",
			[]string{"config", "ws-external-enabled"},
			[]interface{}{testCfgFile.Name(), false},
			dot.RPCConfig{
				Enabled:           testCfg.RPC.Enabled,
