...
# Install subkey
RUN wget -P $HOME/.local/bin/ https://chainbridge.ams3.digitaloceanspaces.com/subkey-v2.0.0
RUN mv $HOME/.local/bin/subkey-v2.0.0 $HOME/.local/bin/subkey
RUN chmod +x $HOME/.local/bin/subkey
