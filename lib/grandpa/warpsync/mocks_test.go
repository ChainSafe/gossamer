...
// Source: github.com/ChainSafe/gossamer/lib/grandpa/warpsync (interfaces: BlockState,GrandpaState)
//
// Generated by this command:
//
//	mockgen -destination=mocks_test.go -package warpsync . BlockState,GrandpaState
//
