...
// GossipMessageTo mocks base method.
func (m *MockNetwork) GossipMessageTo(arg0 peer.ID, arg1 network.NotificationsMessage) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "GossipMessageTo", arg0, arg1)
}

// GossipMessageTo indicates an expected call of GossipMessageTo.
func (mr *MockNetworkMockRecorder) GossipMessageTo(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GossipMessageTo", reflect.TypeOf((*MockNetwork)(nil).GossipMessageTo), arg0, arg1)
}
