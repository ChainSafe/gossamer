...
func (_m *mockNode) decode(r io.Reader, h byte) error {
	ret := _m.Called(r, h)
...
func (_m *mockNode) encode() ([]byte, error) {
	ret := _m.Called()
...
func (_m *mockNode) encodeAndHash() ([]byte, []byte, error) {
	ret := _m.Called()
...
func (_m *mockNode) getGeneration() uint64 {
	ret := _m.Called()
