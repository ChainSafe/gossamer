...
func TestAvailableDataFetchingResponse(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			name:        "AvailableData",
			value:       availableData,
			encodeValue: common.MustHexToBytes("0x0080020202020202020202020202020202020202020202020202020202020202020280030303030303030303030303030303030303030303030303030303030303030304000000050505050505050505050505050505050505050505050505050505050505050506000000"),
		},
		{
			name:        "NoSuchData",
			value:       NoSuchData{},
