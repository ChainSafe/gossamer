...
// Source: github.com/ChainSafe/gossamer/lib/sync (interfaces: Telemetry,BlockState,StorageState,TransactionState,BabeVerifier,FinalityGadget,BlockImportHandler,Network,Importer)
//
// Generated by this command:
//
//	mockgen -destination=mocks_test.go -package=sync . Telemetry,BlockState,StorageState,TransactionState,BabeVerifier,FinalityGadget,BlockImportHandler,Network,Importer
//
...
func (m *MockImporter) handle(arg0 *types.BlockData, arg1 BlockOrigin) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockImporterMockRecorder) handle(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "handle", reflect.TypeOf((*MockImporter)(nil).handle), arg0, arg1)
}
