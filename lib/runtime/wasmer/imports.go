...
func ext_logging_log_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
...
func ext_logging_max_level_version_1(_ interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	return []wasmergo.Value{wasmergo.NewI32(4)}, nil
}

//export ext_transaction_index_index_version_1
func ext_transaction_index_index_version_1(_ interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
...
func ext_transaction_index_renew_version_1(_ interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	logger.Warn("unimplemented")
	return nil, nil
}
...
func ext_sandbox_instance_teardown_version_1(_ interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	logger.Warn("unimplemented")
	return nil, nil
}
...
func ext_sandbox_instantiate_version_1(_ interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	logger.Warn("unimplemented")
	return []wasmergo.Value{wasmergo.NewI32(0)}, nil
}

//export ext_sandbox_invoke_version_1
func ext_sandbox_invoke_version_1(_ interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	logger.Warn("unimplemented")
	return []wasmergo.Value{wasmergo.NewI32(0)}, nil
}
...
func ext_sandbox_memory_get_version_1(_ interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	logger.Warn("unimplemented")
	return []wasmergo.Value{wasmergo.NewI32(0)}, nil
}
...
func ext_sandbox_memory_new_version_1(_ interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	logger.Warn("unimplemented")
	return []wasmergo.Value{wasmergo.NewI32(0)}, nil
}
...
func ext_sandbox_memory_set_version_1(_ interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	logger.Warn("unimplemented")
	return []wasmergo.Value{wasmergo.NewI32(0)}, nil
}
...
func ext_sandbox_memory_teardown_version_1(_ interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	logger.Warn("unimplemented")
	return nil, nil
}
...
func ext_crypto_ed25519_generate_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	...
	if err != nil {
		...
		return []wasmergo.Value{wasmergo.NewI32(0)}, err
	}

	logger.Debug("generated ed25519 keypair with public key: " + kp.Public().Hex())
	return []wasmergo.Value{wasmergo.NewI32(castedRet)}, nil
}

//export ext_crypto_ed25519_public_keys_version_1
func ext_crypto_ed25519_public_keys_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	...
	if err != nil {
		...
		return []wasmergo.Value{wasmergo.NewI64(ret)}, nil
	}
...
func ext_crypto_ed25519_sign_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	...
	if err != nil {
		...
		return []wasmergo.Value{wasmergo.NewI64(0)}, nil
	}
...
func ext_crypto_ed25519_verify_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	...
	if sigVerifier.IsStarted() {
		...
		return []wasmergo.Value{wasmergo.NewI32(1)}, nil
	}
...
func ext_crypto_secp256k1_ecdsa_recover_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
...
func ext_crypto_secp256k1_ecdsa_recover_version_2(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	return ext_crypto_secp256k1_ecdsa_recover_version_1(env, args)
}

//export ext_crypto_ecdsa_verify_version_2
func ext_crypto_ecdsa_verify_version_2(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
...
func ext_crypto_secp256k1_ecdsa_recover_compressed_version_1(env interface{},
	args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	instanceContext := env.(*runtime.Context)
	memory := instanceContext.Memory.Data()
...
func ext_crypto_sr25519_generate_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
...
func ext_crypto_sr25519_public_keys_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_crypto_sr25519_sign_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	runtimeCtx := env.(*runtime.Context)
	memory := runtimeCtx.Memory.Data()
	keyTypeID := args[0].I32()
	...
	if err != nil {
		logger.Warnf("error for id 0x%x: %s", id, err)
		return []wasmergo.Value{wasmergo.NewI64(emptyRet)}, nil
	}
...
func ext_crypto_sr25519_verify_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	...
	if err != nil {
		...
		return []wasmergo.Value{wasmergo.NewI32(0)}, nil //nolint
	}
...
func ext_crypto_sr25519_verify_version_2(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
...
func ext_crypto_start_batch_verify_version_1(_ interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_crypto_finish_batch_verify_version_1(_ interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_trie_blake2_256_root_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	...
	return []wasmergo.Value{wasmergo.NewI32(castedPtr)}, nil
}

//export ext_trie_blake2_256_ordered_root_version_1
func ext_trie_blake2_256_ordered_root_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_trie_blake2_256_ordered_root_version_2(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
...
func ext_trie_blake2_256_verify_proof_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_misc_print_hex_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
...
func ext_misc_print_num_version_1(_ interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	data := args[0].I64()
...
func ext_misc_print_utf8_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
...
func ext_misc_runtime_version_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	...
	return []wasmergo.Value{wasmergo.NewI64(out)}, nil
}

//export ext_default_child_storage_read_version_1
func ext_default_child_storage_read_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	...
	return []wasmergo.Value{wasmergo.NewI64(sizeSpan)}, nil
}

//export ext_default_child_storage_clear_version_1
func ext_default_child_storage_clear_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_default_child_storage_clear_prefix_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_default_child_storage_exists_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_default_child_storage_get_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	...
	return []wasmergo.Value{wasmergo.NewI64(value)}, nil
}

//export ext_default_child_storage_next_key_version_1
func ext_default_child_storage_next_key_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_default_child_storage_root_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	...
	return []wasmergo.Value{wasmergo.NewI64(root)}, nil
}

//export ext_default_child_storage_set_version_1
func ext_default_child_storage_set_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_default_child_storage_storage_kill_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_default_child_storage_storage_kill_version_2(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_default_child_storage_storage_kill_version_3(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	instanceContext := env.(*runtime.Context)
	storage := instanceContext.Storage
	childStorageKeySpan := args[0].I64()
...
func ext_allocator_free_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	runtimeCtx := env.(*runtime.Context)
...
func ext_allocator_malloc_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	...
	return []wasmergo.Value{wasmergo.NewI32(castedRes)}, nil
}

//export ext_hashing_blake2_128_version_1
func ext_hashing_blake2_128_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	instanceContext := env.(*runtime.Context)
	dataSpan := args[0].I64()
	...
	if err != nil {
		...
		return []wasmergo.Value{wasmergo.NewI32(int32(0))}, nil
	}
	...
	return []wasmergo.Value{wasmergo.NewI32(castedOut)}, nil
}

//export ext_hashing_blake2_256_version_1
func ext_hashing_blake2_256_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	instanceContext := env.(*runtime.Context)
	dataSpan := args[0].I64()
	data := asMemorySlice(instanceContext, dataSpan)
...
func ext_hashing_keccak_256_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	instanceContext := env.(*runtime.Context)
	dataSpan := args[0].I64()
	data := asMemorySlice(instanceContext, dataSpan)
...
func ext_hashing_sha2_256_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	instanceContext := env.(*runtime.Context)
	dataSpan := args[0].I64()
	data := asMemorySlice(instanceContext, dataSpan)
...
func ext_hashing_twox_256_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	instanceContext := env.(*runtime.Context)
	dataSpan := args[0].I64()
	data := asMemorySlice(instanceContext, dataSpan)
...
func ext_hashing_twox_128_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	instanceContext := env.(*runtime.Context)
	dataSpan := args[0].I64()
	data := asMemorySlice(instanceContext, dataSpan)
...
func ext_hashing_twox_64_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	instanceContext := env.(*runtime.Context)
	dataSpan := args[0].I64()
	data := asMemorySlice(instanceContext, dataSpan)
...
func ext_offchain_index_set_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	instanceContext := env.(*runtime.Context)
	keySpan := args[0].I64()
...
func ext_offchain_local_storage_clear_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	instanceContext := env.(*runtime.Context)
	kind := args[0].I32()
	key := args[1].I64()
...
func ext_offchain_is_validator_version_1(env interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	instanceContext := env.(*runtime.Context)
	if instanceContext.Validator {
		return []wasmergo.Value{wasmergo.NewI32(int32(1))}, nil
	}
	return []wasmergo.Value{wasmergo.NewI32(int32(0))}, nil
}
...
func ext_offchain_local_storage_get_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	...
	if err != nil {
		logger.Errorf("failed to allocate memory: %s", err)
		return []wasmergo.Value{wasmergo.NewI64(int64(0))}, nil
	}

	return []wasmergo.Value{wasmergo.NewI64(ptr)}, nil
}

//export ext_offchain_local_storage_set_version_1
func ext_offchain_local_storage_set_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_offchain_network_state_version_1(env interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	runtimeCtx := env.(*runtime.Context)
	...
	return []wasmergo.Value{wasmergo.NewI64(int64(ptr))}, nil
}

//export ext_offchain_random_seed_version_1
func ext_offchain_random_seed_version_1(env interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	instanceContext := env.(*runtime.Context)
...
func ext_offchain_submit_transaction_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_offchain_timestamp_version_1(_ interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")

	now := time.Now().Unix()
	return []wasmergo.Value{wasmergo.NewI64(now)}, nil
}

//export ext_offchain_sleep_until_version_1
func ext_offchain_sleep_until_version_1(_ interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	deadline := args[0].I64()
...
func ext_offchain_http_request_start_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
...
func ext_offchain_http_request_add_header_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	instanceContext := env.(*runtime.Context)
	reqID := args[0].I32()
	nameSpan := args[1].I64()
...
func ext_storage_append_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	instanceContext := env.(*runtime.Context)
	keySpan := args[0].I64()
	valueSpan := args[1].I64()
...
func ext_storage_changes_root_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
...
func ext_storage_clear_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	instanceContext := env.(*runtime.Context)
	keySpan := args[0].I64()
	storage := instanceContext.Storage
...
func ext_storage_clear_prefix_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	instanceContext := env.(*runtime.Context)
...
func ext_storage_clear_prefix_version_2(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	...
	return []wasmergo.Value{wasmergo.NewI64(valueSpan)}, nil
}

//export ext_storage_exists_version_1
func ext_storage_exists_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	instanceContext := env.(*runtime.Context)
	keySpan := args[0].I64()
	storage := instanceContext.Storage
...
func ext_storage_get_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
...
func ext_storage_next_key_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	...
	return []wasmergo.Value{wasmergo.NewI64(nextSpan)}, nil
}

//export ext_storage_read_version_1
func ext_storage_read_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
...
func ext_storage_root_version_1(env interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
	...
	return []wasmergo.Value{wasmergo.NewI64(rootSpan)}, nil
}

//export ext_storage_root_version_2
func ext_storage_root_version_2(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	// TODO: update to use state trie version 1 (#2418)
	instanceContext := env.(*runtime.Context)
...
func ext_storage_set_version_1(env interface{}, args []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Trace("executing...")
...
func ext_storage_start_transaction_version_1(env interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	instanceContext := env.(*runtime.Context)
...
func ext_storage_rollback_transaction_version_1(env interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	instanceContext := env.(*runtime.Context)
...
func ext_storage_commit_transaction_version_1(env interface{}, _ []wasmergo.Value) ([]wasmergo.Value, error) {
	logger.Debug("executing...")
	instanceContext := env.(*runtime.Context)
