...
func ext_trie_blake2_256_verify_proof_version_1(context unsafe.Pointer, _, _, _, _ C.int64_t) C.int32_t {
...
func ext_offchain_http_request_start_version_1(context unsafe.Pointer, methodSpan, uriSpan, _ C.int64_t) C.int64_t {
	logger.Debug("executing...")
