...
const Name = "oldWasmer"

var (
	logger = log.NewFromGlobal(
		log.AddContext("pkg", "runtime"),
		log.AddContext("module", "go-oldWasmer"),
	)
)

// Instance represents a v0.8 runtime go-oldWasmer instance
...
func setupVM(code []byte) (instance wasm.Instance,
	...
	// should be doable w/ oldWasmer 1.0.0. (#1268)
	...
	// oldWasmer 0.3.x does not support this, but oldWasmer 1.0.0 does (#1268)
