...
func ext_crypto_ed25519_generate_version_1(vm *exec.VirtualMachine) int64 {
	...
	err = ks.Insert(kp)
	if err != nil {
		logger.Warn("[ext_crypto_ed25519_generate_version_1] failed to insert key", "error", err)
		return 0
	}
...
func ext_crypto_sr25519_generate_version_1(vm *exec.VirtualMachine) int64 {
	...
	err = ks.Insert(kp)
	if err != nil {
		logger.Warn("[ext_crypto_sr25519_generate_version_1] failed to insert key", "error", err)
		return 0
	}
