...
const (
	...
	// v0.9.12 westend used for zero-address bug
	WESTEND_RUNTIME_v0912     = "westend_runtime-v9111"
	WESTEND_RUNTIME_V0912_FP  = "westend_runtime-v9111.compact.wasm"
	WESTEND_RUNTIME_V0912_URL = "https://github.com/paritytech/polkadot/releases/download/v0.9." +
		"11/westend_runtime-v9111.compact.compressed.wasm?raw=true"
)
