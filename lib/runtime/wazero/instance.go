...
func newRuntime(ctx context.Context,
	...
	hostCompiledModule, err := rt.NewHostModuleBuilder("env").
		...
		NewFunctionBuilder().
		WithGoModuleFunction(wrap3ret(ext_crypto_sr25519_sign_version_1), []api.ValueType{i32, i32, i64}, []api.ValueType{i64}).
		Export("ext_crypto_sr25519_sign_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap3ret(ext_crypto_sr25519_verify_version_1), []api.ValueType{i32, i64, i32}, []api.ValueType{i32}).
		Export("ext_crypto_sr25519_verify_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap3ret(ext_crypto_sr25519_verify_version_2), []api.ValueType{i32, i64, i32}, []api.ValueType{i32}).
		Export("ext_crypto_sr25519_verify_version_2").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap0(ext_crypto_start_batch_verify_version_1), []api.ValueType{}, []api.ValueType{}).
		Export("ext_crypto_start_batch_verify_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap0ret(ext_crypto_finish_batch_verify_version_1), []api.ValueType{}, []api.ValueType{i32}).
		Export("ext_crypto_finish_batch_verify_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_trie_blake2_256_root_version_1), []api.ValueType{i64}, []api.ValueType{i32}).
		Export("ext_trie_blake2_256_root_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2ret(ext_trie_blake2_256_root_version_2), []api.ValueType{i64, i32}, []api.ValueType{i32}).
		Export("ext_trie_blake2_256_root_version_2").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_trie_blake2_256_ordered_root_version_1), []api.ValueType{i64}, []api.ValueType{i32}).
		Export("ext_trie_blake2_256_ordered_root_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2ret(ext_trie_blake2_256_ordered_root_version_2), []api.ValueType{i64, i32}, []api.ValueType{i32}).
		Export("ext_trie_blake2_256_ordered_root_version_2").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap4ret(ext_trie_blake2_256_verify_proof_version_1), []api.ValueType{i32, i64, i64, i64}, []api.ValueType{i32}).
		Export("ext_trie_blake2_256_verify_proof_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap5ret(ext_trie_blake2_256_verify_proof_version_2), []api.ValueType{i32, i64, i64, i64, i32}, []api.ValueType{i32}).
		Export("ext_trie_blake2_256_verify_proof_version_2").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1(ext_misc_print_hex_version_1), []api.ValueType{i64}, []api.ValueType{}).
		Export("ext_misc_print_hex_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1(ext_misc_print_num_version_1), []api.ValueType{i64}, []api.ValueType{}).
		Export("ext_misc_print_num_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1(ext_misc_print_utf8_version_1), []api.ValueType{i64}, []api.ValueType{}).
		Export("ext_misc_print_utf8_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_misc_runtime_version_version_1), []api.ValueType{i64}, []api.ValueType{i64}).
		Export("ext_misc_runtime_version_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap3(ext_default_child_storage_set_version_1), []api.ValueType{i64, i64, i64}, []api.ValueType{}).
		Export("ext_default_child_storage_set_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap4ret(ext_default_child_storage_read_version_1), []api.ValueType{i64, i64, i64, i32}, []api.ValueType{i64}).
		Export("ext_default_child_storage_read_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2(ext_default_child_storage_clear_version_1), []api.ValueType{i64, i64}, []api.ValueType{}).
		Export("ext_default_child_storage_clear_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2(ext_default_child_storage_clear_prefix_version_1), []api.ValueType{i64, i64}, []api.ValueType{}).
		Export("ext_default_child_storage_clear_prefix_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap3ret(ext_default_child_storage_clear_prefix_version_2), []api.ValueType{i64, i64, i64}, []api.ValueType{i64}).
		Export("ext_default_child_storage_clear_prefix_version_2").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2ret(ext_default_child_storage_exists_version_1), []api.ValueType{i64, i64}, []api.ValueType{i32}).
		Export("ext_default_child_storage_exists_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2ret(ext_default_child_storage_get_version_1), []api.ValueType{i64, i64}, []api.ValueType{i64}).
		Export("ext_default_child_storage_get_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2ret(ext_default_child_storage_next_key_version_1), []api.ValueType{i64, i64}, []api.ValueType{i64}).
		Export("ext_default_child_storage_next_key_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_default_child_storage_root_version_1), []api.ValueType{i64}, []api.ValueType{i64}).
		Export("ext_default_child_storage_root_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2ret(ext_default_child_storage_root_version_2), []api.ValueType{i64, i32}, []api.ValueType{i64}).
		Export("ext_default_child_storage_root_version_2").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1(ext_default_child_storage_storage_kill_version_1), []api.ValueType{i64}, []api.ValueType{}).
		Export("ext_default_child_storage_storage_kill_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2ret(ext_default_child_storage_storage_kill_version_2), []api.ValueType{i64, i64}, []api.ValueType{i32}).
		Export("ext_default_child_storage_storage_kill_version_2").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2ret(ext_default_child_storage_storage_kill_version_3), []api.ValueType{i64, i64}, []api.ValueType{i64}).
		Export("ext_default_child_storage_storage_kill_version_3").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1(ext_allocator_free_version_1), []api.ValueType{i32}, []api.ValueType{}).
		Export("ext_allocator_free_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_allocator_malloc_version_1), []api.ValueType{i32}, []api.ValueType{i32}).
		Export("ext_allocator_malloc_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_hashing_blake2_128_version_1), []api.ValueType{i64}, []api.ValueType{i32}).
		Export("ext_hashing_blake2_128_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_hashing_blake2_256_version_1), []api.ValueType{i64}, []api.ValueType{i32}).
		Export("ext_hashing_blake2_256_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_hashing_keccak_256_version_1), []api.ValueType{i64}, []api.ValueType{i32}).
		Export("ext_hashing_keccak_256_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_hashing_sha2_256_version_1), []api.ValueType{i64}, []api.ValueType{i32}).
		Export("ext_hashing_sha2_256_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_hashing_twox_256_version_1), []api.ValueType{i64}, []api.ValueType{i32}).
		Export("ext_hashing_twox_256_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_hashing_twox_128_version_1), []api.ValueType{i64}, []api.ValueType{i32}).
		Export("ext_hashing_twox_128_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_hashing_twox_64_version_1), []api.ValueType{i64}, []api.ValueType{i32}).
		Export("ext_hashing_twox_64_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2(ext_offchain_index_set_version_1), []api.ValueType{i64, i64}, []api.ValueType{}).
		Export("ext_offchain_index_set_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1(ext_offchain_index_clear_version_1), []api.ValueType{i64}, []api.ValueType{}).
		Export("ext_offchain_index_clear_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2(ext_offchain_local_storage_clear_version_1), []api.ValueType{i32, i64}, []api.ValueType{}).
		Export("ext_offchain_local_storage_clear_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap0ret(ext_offchain_is_validator_version_1), []api.ValueType{}, []api.ValueType{i32}).
		Export("ext_offchain_is_validator_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap4ret(ext_offchain_local_storage_compare_and_set_version_1), []api.ValueType{i32, i64, i64, i64}, []api.ValueType{i32}).
		Export("ext_offchain_local_storage_compare_and_set_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2ret(ext_offchain_local_storage_get_version_1), []api.ValueType{i32, i64}, []api.ValueType{i64}).
		Export("ext_offchain_local_storage_get_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap3(ext_offchain_local_storage_set_version_1), []api.ValueType{i32, i64, i64}, []api.ValueType{}).
		Export("ext_offchain_local_storage_set_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap0ret(ext_offchain_network_state_version_1), []api.ValueType{}, []api.ValueType{i64}).
		Export("ext_offchain_network_state_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap0ret(ext_offchain_random_seed_version_1), []api.ValueType{}, []api.ValueType{i32}).
		Export("ext_offchain_random_seed_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_offchain_submit_transaction_version_1), []api.ValueType{i64}, []api.ValueType{i64}).
		Export("ext_offchain_submit_transaction_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap0ret(ext_offchain_timestamp_version_1), []api.ValueType{}, []api.ValueType{i64}).
		Export("ext_offchain_timestamp_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1(ext_offchain_sleep_until_version_1), []api.ValueType{i64}, []api.ValueType{}).
		Export("ext_offchain_sleep_until_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap3ret(ext_offchain_http_request_start_version_1), []api.ValueType{i64, i64, i64}, []api.ValueType{i64}).
		Export("ext_offchain_http_request_start_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap3ret(ext_offchain_http_request_add_header_version_1), []api.ValueType{i32, i64, i64}, []api.ValueType{i64}).
		Export("ext_offchain_http_request_add_header_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2(ext_storage_append_version_1), []api.ValueType{i64, i64}, []api.ValueType{}).
		Export("ext_storage_append_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_storage_changes_root_version_1), []api.ValueType{i64}, []api.ValueType{i64}).
		Export("ext_storage_changes_root_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1(ext_storage_clear_version_1), []api.ValueType{i64}, []api.ValueType{}).
		Export("ext_storage_clear_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1(ext_storage_clear_prefix_version_1), []api.ValueType{i64}, []api.ValueType{}).
		Export("ext_storage_clear_prefix_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2ret(ext_storage_clear_prefix_version_2), []api.ValueType{i64, i64}, []api.ValueType{i64}).
		Export("ext_storage_clear_prefix_version_2").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_storage_exists_version_1), []api.ValueType{i64}, []api.ValueType{i32}).
		Export("ext_storage_exists_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_storage_get_version_1), []api.ValueType{i64}, []api.ValueType{i64}).
		Export("ext_storage_get_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_storage_next_key_version_1), []api.ValueType{i64}, []api.ValueType{i64}).
		Export("ext_storage_next_key_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap3ret(ext_storage_read_version_1), []api.ValueType{i64, i64, i32}, []api.ValueType{i64}).
		Export("ext_storage_read_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap0ret(ext_storage_root_version_1), []api.ValueType{}, []api.ValueType{i64}).
		Export("ext_storage_root_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap1ret(ext_storage_root_version_2), []api.ValueType{i32}, []api.ValueType{i64}).
		...
		NewFunctionBuilder().
		WithGoModuleFunction(wrap0(ext_storage_rollback_transaction_version_1), []api.ValueType{}, []api.ValueType{}).
		Export("ext_storage_rollback_transaction_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap0(ext_storage_commit_transaction_version_1), []api.ValueType{}, []api.ValueType{}).
		Export("ext_storage_commit_transaction_version_1").
		NewFunctionBuilder().
		WithGoModuleFunction(wrap2ret(ext_crypto_ecdsa_generate_version_1), []api.ValueType{i32, i64}, []api.ValueType{i32}).
